...
class FirstOrderHold:
    def __init__(self, m, K):
        ...
        self.V0[self.A_bar_ind] = np.eye(m.n_x).reshape(-1)  # identity matrix
    ...
    def calculate_discretization(self, X, U, sigma):
        ...
        for k in range(self.K - 1):
            ...
            V = solve_ivp(self._ode_dVdt, [0, self.dt], self.V0, args=(U[:, k], U[:, k + 1], sigma),
    ...
    def _ode_dVdt(self, t, V, u_t0, u_t1, sigma):
        ...
        dVdt[self.x_ind] = f_subs.transpose()
