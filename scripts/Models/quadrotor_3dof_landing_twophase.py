...
from scripts.Configuration.parameters_3dof_landing_twophase import K_3dof as K
...
class Model:
    ...
    def __init__(self, quad_name):
        ...
        if quad_name=="iris":
            ...
            self.T_max = 21.
            self.T_min = 5.
            self.u_init = self.mass*np.array((0., 0., 9.81))
            self.u_final = self.mass*np.array((0., 0., 9.81))
    ...
    def get_constraints(self, X_v, U_v, p_init, v_init, p_final, v_final, u_init, u_final):
        """
        ...
        # Boundary conditions:
        K_1 = U_v.shape[1]
        self.sigma = cvx.Variable(K_1, nonneg=True)
    ...
    def get_constraints_only_1st_phase(self, X_v, U_v, p_init, v_init, p_final, v_final, u_init, u_final):
        """
        Get model specific constraints.
